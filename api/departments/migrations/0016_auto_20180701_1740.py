...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('departments', '0015_auto_20180625_1120'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='patient',
            name='department',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='departments', to='departments.Department'),
        ),
        migrations.AlterField(
            model_name='patient',
            name='user',
